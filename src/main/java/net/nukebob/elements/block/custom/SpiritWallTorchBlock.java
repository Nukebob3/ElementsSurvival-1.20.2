...
public class SpiritWallTorchBlock
        extends TorchBlock {
    ...
    public SpiritWallTorchBlock(AbstractBlock.Settings settings, ParticleEffect particleEffect) {
    ...
    public VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        return net.minecraft.block.WallTorchBlock.getBoundingShape(state);
    }
